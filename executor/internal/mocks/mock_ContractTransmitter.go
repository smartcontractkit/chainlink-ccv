...
func (_m *MockContractTransmitter) ConvertAndWriteMessageToChain(ctx context.Context, report types.AbstractAggregatedReport) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, types.AbstractAggregatedReport) error); ok {
		r0 = rf(ctx, report)
	} else {
		r0 = ret.Error(0)
	}
...
//   - ctx context.Context
//   - report types.AbstractAggregatedReport
...
func (_c *MockContractTransmitter_ConvertAndWriteMessageToChain_Call) Run(run func(ctx context.Context, report types.AbstractAggregatedReport)) *MockContractTransmitter_ConvertAndWriteMessageToChain_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(types.AbstractAggregatedReport))
	})
	return _c
}
...
func (_c *MockContractTransmitter_ConvertAndWriteMessageToChain_Call) RunAndReturn(run func(context.Context, types.AbstractAggregatedReport) error) *MockContractTransmitter_ConvertAndWriteMessageToChain_Call {
	_c.Call.Return(run)
	return _c
}
