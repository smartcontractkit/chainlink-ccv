...
func (_m *MockExecutor) CheckValidMessage(ctx context.Context, messageWithCCVData types.MessageWithCCVData) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, types.MessageWithCCVData) error); ok {
...
//   - ctx context.Context
//   - messageWithCCVData types.MessageWithCCVData
...
func (_c *MockExecutor_CheckValidMessage_Call) Run(run func(ctx context.Context, messageWithCCVData types.MessageWithCCVData)) *MockExecutor_CheckValidMessage_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(types.MessageWithCCVData))
	})
	return _c
}
...
func (_c *MockExecutor_CheckValidMessage_Call) RunAndReturn(run func(context.Context, types.MessageWithCCVData) error) *MockExecutor_CheckValidMessage_Call {
	_c.Call.Return(run)
	return _c
}

// ExecuteMessage provides a mock function with given fields: ctx, messageWithCCVData
func (_m *MockExecutor) ExecuteMessage(ctx context.Context, messageWithCCVData types.MessageWithCCVData) error {
	ret := _m.Called(ctx, messageWithCCVData)
...
func (_c *MockExecutor_ExecuteMessage_Call) Run(run func(ctx context.Context, messageWithCCVData types.MessageWithCCVData)) *MockExecutor_ExecuteMessage_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(types.MessageWithCCVData))
	})
	return _c
...
func (_c *MockExecutor_ExecuteMessage_Call) RunAndReturn(run func(context.Context, types.MessageWithCCVData) error) *MockExecutor_ExecuteMessage_Call {
	_c.Call.Return(run)
	return _c
}
