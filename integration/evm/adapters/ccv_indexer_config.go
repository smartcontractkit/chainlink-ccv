...
import (
	...
	lombardverifier "github.com/smartcontractkit/chainlink-ccip/chains/evm/deployment/v2_2_0/operations/lombard_verifier"
...
func resolveEVMCCVIndexerContractMeta(kind ccvdeploymentadapters.VerifierKind) (cldfdeployment.ContractType, *semver.Version, error) {
	...
	case ccvdeploymentadapters.CCTPVerifierKind:
		return versioned_verifier_resolver.CCTPVerifierResolverType, versioned_verifier_resolver.Version, nil
