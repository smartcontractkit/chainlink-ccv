...
require (
	...
	github.com/smartcontractkit/chainlink-ccv v0.0.0-20251016121407-188eb5517cab
...
require (
	...
	github.com/smartcontractkit/chainlink-testing-framework/framework v0.10.33 // indirect
