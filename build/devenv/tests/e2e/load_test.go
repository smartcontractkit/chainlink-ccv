...
func (m *EVMTXGun) Call(_ *wasp.Generator) *wasp.Response {
	...
	err = m.impl.SendExampleArgsV3Message(ctx, m.e, m.cfg.CLDF.Addresses, m.selectors, srcChain.ChainSelector, dstChain.ChainSelector, uint16(1), "0x9A9f2CCfdE556A7E9Ff0848998Aa4a0CFD8863AE", nil, nil,
		[]types.CCV{
			{
