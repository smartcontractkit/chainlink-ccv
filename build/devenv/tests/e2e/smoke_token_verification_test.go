...
func runUSDCTestCase(
	...
	messageOptions := cciptestinterfaces.MessageOptions{
		...
		Executor:          getContractAddress(t, in, sourceSelector, datastore.ContractType(sequences.ExecutorProxyType), executor.Version.String(), common.DefaultExecutorQualifier, "executor"),
	}
