...
func (_m *MockSourceReader) VerificationTaskChannel() <-chan verifier.VerificationTask {
	ret := _m.Called()
	...
	var r0 <-chan verifier.VerificationTask
	if rf, ok := ret.Get(0).(func() <-chan verifier.VerificationTask); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(<-chan verifier.VerificationTask)
		}
	}
...
func (_c *MockSourceReader_VerificationTaskChannel_Call) Return(_a0 <-chan verifier.VerificationTask) *MockSourceReader_VerificationTaskChannel_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockSourceReader_VerificationTaskChannel_Call) RunAndReturn(run func() <-chan verifier.VerificationTask) *MockSourceReader_VerificationTaskChannel_Call {
	_c.Call.Return(run)
	return _c
}
