...
func (bh *BlockchainHelper) GetBlockchainByChainSelector(chainSelector protocol.ChainSelector) (*BlockchainInfo, error) {
...
func (bh *BlockchainHelper) GetRPCEndpoint(chainSelector protocol.ChainSelector) (string, error) {
...
func (bh *BlockchainHelper) GetBlockchainInfo(chainSelector protocol.ChainSelector) (string, error) {
	info, err := bh.GetBlockchainByChainSelector(chainSelector)
	if err != nil {
		return "", err
	}
...
func (bh *BlockchainHelper) GetWebSocketEndpoint(chainSelector protocol.ChainSelector) (string, error) {
	info, err := bh.GetBlockchainByChainSelector(chainSelector)
	if err != nil {
		return "", err
	}
...
func (bh *BlockchainHelper) GetAllNodes(chainSelector protocol.ChainSelector) ([]*Node, error) {
	info, err := bh.GetBlockchainByChainSelector(chainSelector)
	if err != nil {
		return nil, err
	}
...
func (bh *BlockchainHelper) GetInternalRPCEndpoint(chainSelector protocol.ChainSelector) (string, error) {
	info, err := bh.GetBlockchainByChainSelector(chainSelector)
	if err != nil {
		return "", err
	}
