...
ALTER TABLE ccv_chain_statuses
    ADD PRIMARY KEY (chain_selector, verifier_id);
...
ALTER TABLE ccv_chain_statuses
    ADD PRIMARY KEY (chain_selector);
