...
func TestVerifier_VerifyMessages_Success(t *testing.T) {
	...
	// Version tag (0xd51b221b) + length prefix (0x0003) + payload (0xabcdef) + length prefix (0x0002) + proof (0x1122)
	expectedSig1 := "0xd51b221b0003abcdef00021122"
	...
	// Version tag (0xd51b221b) + length prefix (0x0003) + payload (0x123456) + length prefix (0x0003) + proof (0x334455)
	expectedSig2 := "0xd51b221b00031234560003334455"
