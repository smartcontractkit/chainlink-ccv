...
type Config struct {
	...
	// verifier consults after finality and the built-in checks pass and before it signs. Absent
	// (the default) leaves the verifier behaving exactly as it did before the hook existed; the
