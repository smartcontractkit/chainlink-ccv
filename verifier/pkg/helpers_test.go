...
func (m *noopMetricLabeler) SetSourceReaderLogPollerGapBlocks(context.Context, int64)            {}
...
func createTestMessageSentEvents(
	...
	for i, blockNum := range blockNumbers {
		...
		message := testutil.CreateTestMessage(t, protocol.SequenceNumber(sequenceNumber), chainSelector, destChain, 0, 300_000)
