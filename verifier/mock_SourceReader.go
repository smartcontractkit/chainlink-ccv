...
func (_m *MockSourceReader) VerificationTasks(ctx context.Context, fromBlock *big.Int, toBlock *big.Int) ([]VerificationTask, error) {
	...
	var r0 []VerificationTask
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *big.Int, *big.Int) ([]VerificationTask, error)); ok {
		return rf(ctx, fromBlock, toBlock)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *big.Int, *big.Int) []VerificationTask); ok {
		r0 = rf(ctx, fromBlock, toBlock)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]VerificationTask)
		}
	}
...
func (_c *MockSourceReader_VerificationTasks_Call) Return(_a0 []VerificationTask, _a1 error) *MockSourceReader_VerificationTasks_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockSourceReader_VerificationTasks_Call) RunAndReturn(run func(context.Context, *big.Int, *big.Int) ([]VerificationTask, error)) *MockSourceReader_VerificationTasks_Call {
	_c.Call.Return(run)
	return _c
}
