...
func (r *SourceReaderService2) readyToQuery(ctx context.Context) (bool, *protocol.BlockHeader) {
...
func (r *SourceReaderService2) addToPendingQueueHandleReorg(tasks []VerificationTask) {
