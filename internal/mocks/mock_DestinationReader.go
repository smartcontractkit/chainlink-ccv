...
func (_m *MockDestinationReader) GetCCVSForMessage(ctx context.Context, message protocol.Message) (protocol.CCVAddressInfo, error) {
	...
	var r0 protocol.CCVAddressInfo
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, protocol.Message) (protocol.CCVAddressInfo, error)); ok {
		return rf(ctx, message)
	}
	if rf, ok := ret.Get(0).(func(context.Context, protocol.Message) protocol.CCVAddressInfo); ok {
		r0 = rf(ctx, message)
	} else {
		r0 = ret.Get(0).(protocol.CCVAddressInfo)
	}
...
func (_c *MockDestinationReader_GetCCVSForMessage_Call) Return(_a0 protocol.CCVAddressInfo, _a1 error) *MockDestinationReader_GetCCVSForMessage_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockDestinationReader_GetCCVSForMessage_Call) RunAndReturn(run func(context.Context, protocol.Message) (protocol.CCVAddressInfo, error)) *MockDestinationReader_GetCCVSForMessage_Call {
	_c.Call.Return(run)
	return _c
}

// GetExecutionAttempts provides a mock function with given fields: ctx, message
func (_m *MockDestinationReader) GetExecutionAttempts(ctx context.Context, message protocol.Message) ([]protocol.ExecutionAttempt, error) {
	ret := _m.Called(ctx, message)
	...
	var r0 []protocol.ExecutionAttempt
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, protocol.Message) ([]protocol.ExecutionAttempt, error)); ok {
		return rf(ctx, message)
	}
	if rf, ok := ret.Get(0).(func(context.Context, protocol.Message) []protocol.ExecutionAttempt); ok {
		r0 = rf(ctx, message)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]protocol.ExecutionAttempt)
		}
	}
...
func (_c *MockDestinationReader_GetExecutionAttempts_Call) Return(_a0 []protocol.ExecutionAttempt, _a1 error) *MockDestinationReader_GetExecutionAttempts_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockDestinationReader_GetExecutionAttempts_Call) RunAndReturn(run func(context.Context, protocol.Message) ([]protocol.ExecutionAttempt, error)) *MockDestinationReader_GetExecutionAttempts_Call {
	_c.Call.Return(run)
	return _c
}
