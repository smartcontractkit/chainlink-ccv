...
func (_m *MockService) HealthReport() map[string]error {
	ret := _m.Called()
...
// MockService_HealthReport_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'HealthReport'
type MockService_HealthReport_Call struct {
	*mock.Call
}

// HealthReport is a helper method to define mock.On call
func (_e *MockService_Expecter) HealthReport() *MockService_HealthReport_Call {
	return &MockService_HealthReport_Call{Call: _e.mock.On("HealthReport")}
}

func (_c *MockService_HealthReport_Call) Run(run func()) *MockService_HealthReport_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockService_HealthReport_Call) Return(_a0 map[string]error) *MockService_HealthReport_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockService_HealthReport_Call) RunAndReturn(run func() map[string]error) *MockService_HealthReport_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *MockService_Ready_Call) Return(_a0 error) *MockService_Ready_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockService_Ready_Call) RunAndReturn(run func() error) *MockService_Ready_Call {
	_c.Call.Return(run)
	return _c
}

// Start provides a mock function with given fields: _a0
func (_m *MockService) Start(_a0 context.Context) error {
	ret := _m.Called(_a0)
...
//   - _a0 context.Context
func (_e *MockService_Expecter) Start(_a0 interface{}) *MockService_Start_Call {
	return &MockService_Start_Call{Call: _e.mock.On("Start", _a0)}
}

func (_c *MockService_Start_Call) Run(run func(_a0 context.Context)) *MockService_Start_Call {
	_c.Call.Run(func(args mock.Arguments) {
