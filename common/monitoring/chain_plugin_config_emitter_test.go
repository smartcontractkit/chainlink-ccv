...
func TestNewChainPluginConfigEmitterDefaults(t *testing.T) {
	...
	emitter := NewChainPluginConfigEmitter(
		logger.Test(t),
		"",
		"",
	...
	require.Equal(t, DefaultChainPluginConfigEmitInterval, emitter.interval)
...
func TestChainPluginConfigEmitterStartDefaults(t *testing.T) {
	emitter := NewChainPluginConfigEmitter(
		logger.Test(t),
		"csa-123",
		"chain-1",
...
func TestChainPluginConfigEmitterEmit(t *testing.T) {
