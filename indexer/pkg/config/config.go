...
type GeneratedVerifierConfig struct {
	...
	IssuerAddresses []string `json:"issuerAddresses" toml:"IssuerAddresses"`
}
...
type GeneratedConfig struct {
	Verifier []GeneratedVerifierConfig `json:"verifiers" toml:"Verifier"`
}
...
type PostgresConfig struct {
	...
	// ConnMaxLifetime is the maximum lifetime of a connection. 0 defaults to 1 hour.
