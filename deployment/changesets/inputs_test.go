...
func TestFilterNOPsWithJDChainConfigs_SkipsStandalone(t *testing.T) {
	got := filterNOPsWithJDChainConfigs(
...
func TestFilterNOPsWithJDChainConfigs_TreatsMissingAsUnavailable(t *testing.T) {
	got := filterNOPsWithJDChainConfigs(
