...
// filterNOPsWithJDChainConfigs returns the aliases whose chain support can be
// validated through JD. Standalone nodes declare their supported chains in the
// bootstrap config, but JD does not currently expose those declarations as node
// chain configs.
func filterNOPsWithJDChainConfigs(aliases []shared.NOPAlias, nops []NOPInput) []shared.NOPAlias {
