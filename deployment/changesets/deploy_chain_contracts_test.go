...
func registerChainContractsDeployAdapter() {
	adapters.GetChainContractsDeployRegistry().Register(chainsel.FamilyEVM, &stubChainContractsDeployAdapter{})
}
...
func TestDeployChainContracts_Validation_NoChainSelectors(t *testing.T) {
	registerChainContractsDeployAdapter()
	cs := DeployChainContracts()
