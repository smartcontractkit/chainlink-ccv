...
// This ensures the same JobID always produces the same externalJobID across deployments.
// The namespace itself is a static, randomly chosen UUID that should never change.
...
// AddProposal adds or updates a proposal in the job's proposal history.
...
// SetActiveProposal sets the active proposal if the given proposal is approved.
