...
import (
	...
	"github.com/smartcontractkit/chainlink-ccv/deployments/operations/propose_jobs"
	"github.com/smartcontractkit/chainlink-ccv/deployments/operations/revoke_jobs"
...
var ManageJobProposals = operations.NewSequence(
	...
	func(b operations.Bundle, deps ManageJobProposalsDeps, input ManageJobProposalsInput) (ManageJobProposalsOutput, error) {
		...
		if err := deployments.SaveJobs(ds, jobs); err != nil {
