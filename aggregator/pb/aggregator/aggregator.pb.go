...
type Any2AnyMessageHeader struct {
	...
	MessageId           uint32                 `protobuf:"fixed32,1,opt,name=message_id,json=messageId,proto3" json:"message_id,omitempty"`
...
func (x *Any2AnyMessageHeader) GetMessageId() uint32 {
	if x != nil {
		return x.MessageId
	}
	return 0
...
func (x *CommitVerificationRecord) GetMessageId() uint32 {
	if x != nil {
		return x.MessageId
	}
	return 0
...
func (x *ReadCommitVerificationRequest) GetMessageId() uint32 {
	if x != nil {
		return x.MessageId
	}
	return 0
...
const file_proto_aggregator_proto_rawDesc = "" +
	...
	"\n" +
	"message_id\x18\x01 \x01(\aR\tmessageId\x122\n" +
	...
	"\n" +
	"message_id\x18\x01 \x01(\aR\tmessageId\x12'\n" +
