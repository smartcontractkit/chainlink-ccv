...
func TestGetBatchCCVDataForMessageHandler_MixedResults(t *testing.T) {
	...
	report1 := makeAggregatedReport(m1ID[:], sourceSel, destSel, sourceVerifierAddr, signerAddr)
	report2 := makeAggregatedReport(m2ID[:], sourceSel, 99999, sourceVerifierAddr, signerAddr)
