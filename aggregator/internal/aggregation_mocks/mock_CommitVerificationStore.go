...
// ListOrphanedMessageIDs provides a mock function with given fields: ctx, committeeID
func (_m *MockCommitVerificationStore) ListOrphanedMessageIDs(ctx context.Context, committeeID string) (<-chan []byte, <-chan error) {
	ret := _m.Called(ctx, committeeID)

	if len(ret) == 0 {
		panic("no return value specified for ListOrphanedMessageIDs")
	}

	var r0 <-chan []byte
	var r1 <-chan error
	if rf, ok := ret.Get(0).(func(context.Context, string) (<-chan []byte, <-chan error)); ok {
...
// MockCommitVerificationStore_ListOrphanedMessageIDs_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ListOrphanedMessageIDs'
type MockCommitVerificationStore_ListOrphanedMessageIDs_Call struct {
	*mock.Call
}

// ListOrphanedMessageIDs is a helper method to define mock.On call
//   - ctx context.Context
//   - committeeID string
func (_e *MockCommitVerificationStore_Expecter) ListOrphanedMessageIDs(ctx interface{}, committeeID interface{}) *MockCommitVerificationStore_ListOrphanedMessageIDs_Call {
	return &MockCommitVerificationStore_ListOrphanedMessageIDs_Call{Call: _e.mock.On("ListOrphanedMessageIDs", ctx, committeeID)}
}

func (_c *MockCommitVerificationStore_ListOrphanedMessageIDs_Call) Run(run func(ctx context.Context, committeeID string)) *MockCommitVerificationStore_ListOrphanedMessageIDs_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockCommitVerificationStore_ListOrphanedMessageIDs_Call) Return(_a0 <-chan []byte, _a1 <-chan error) *MockCommitVerificationStore_ListOrphanedMessageIDs_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockCommitVerificationStore_ListOrphanedMessageIDs_Call) RunAndReturn(run func(context.Context, string) (<-chan []byte, <-chan error)) *MockCommitVerificationStore_ListOrphanedMessageIDs_Call {
	_c.Call.Return(run)
	return _c
}
